...
const Faq = () => {
  return (
    <section className="relative z-20 overflow-hidden pb-12 pt-10 lg:w-[80%] lg:m-auto dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
              <span className="mb-2 block text-lg font-semibold text-darkbutton">
                FAQ
              </span>
              <h2 className="mb-4 text-3xl font-bold text-darkbutton dark:text-darkuse  sm:text-[40px]/[48px]">
      ...
      <div className="absolute bottom-0 right-0 z-[-1]">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stop-color="#B2DD68" stop-opacity="0.36" />
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-dark-2 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.10)] sm:p-8 lg:px-6 xl:px-8">
      <button
        className={`faq-btn flex w-full text-left`}
        onClick={() => handleToggle()}
      >
        <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-primary/5 text-darkuse dark:bg-white/5">
          <svg
        ...
        <div className="w-full">
          <h4 className="mt-1 text-lg font-semibold text-darkbutton     dark:text-darkuse">
            {header}
          </h4>
        </div>
      </button>
      ...
      >
        <p className="py-3 text-base leading-relaxed text-darkuse dark:text-darkuse">
          {text}
        </p>
      </div>
    </div>
