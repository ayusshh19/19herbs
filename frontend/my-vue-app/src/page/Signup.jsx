...
function Signup() {
  ...
  return (
    <Usercontextprovider>
      <Navbar />
      <div class="pb-16">
        <div class="flex  rounded-lg shadow-xl mt-5 overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          ...
          <div class="w-full p-8 lg:w-1/2">
            ...
            <p class="text-xl text-darkbutton text-center">
              Welcome create an free account to join us!
            </p>
            <a
              href="#"
              class="flex items-center justify-center mt-4 bg-white rounded-lg shadow-md hover:bg-gray-100"
            >
              <div class="px-4 py-3">
              ...
              <h1 class="px-4 py-3 w-5/6 text-center text-darkbutton font-bold">
                Sign in with Google
              </h1>
            </a>
            ...
            <div class=" grid grid-cols-1 gap-x-6 mt-2 sm:grid-cols-6">
              <div class="sm:col-span-3">
                <label
                  for="first-name"
                  class="block text-sm font-bold leading-6 text-darkbutton"
                >
                  First name
                </label>
                <div class="mt-2">
