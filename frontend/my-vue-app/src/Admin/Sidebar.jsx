...
function Sidebar() {
  ...
  function openNav() {
    const sidebar = document.querySelector(".mainasidecontainer");
    console.log(sidebar);
  ...
  return (
    <div>
      <div class="fixed w-full z-30 flex bg-white dark:bg-darkuse p-2 items-center justify-center h-16 px-10">
        <div
          class="logo ml-12 dark:text-white  transform ease-in-out duration-500 flex-none h-full cursor-pointer flex items-center justify-center"
          onClick={() => navigate("/")}
        >
          19 HERBS
        </div>
        ...
        <div class="flex-none h-full text-center flex items-center justify-center">
          <div class="flex space-x-3 items-center px-3">
            ...
            <div class="hidden md:block text-sm md:text-md text-black dark:text-darkuse ">
              John Doe
            </div>
          </div>
        </div>
      </div>
      <aside class="w-60 -translate-x-48 mainasidecontainer fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
        {/* <!-- open sidebar button --> */}
        <div class="max-toolbar translate-x-24 scale-x-0 w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-white dark:border-[#0F172A] bg-[#1E293B]  absolute top-2 rounded-full h-12">
          ...
          <div class="flex items-center space-x-3 group bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-purple-500  pl-10 pr-2 py-1 rounded-full text-white  ">
            <div class="transform ease-in-out duration-300 mr-12">19 HERBS</div>
          </div>
        </div>
        <div
          onClick={() => openNav()}
        ...
        <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
          ...
          <Link to={"/admin/review"}>
            <div class="hover:ml-4 w-full text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
            <svg class="h-6 w-6 text-white"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" /></svg>
